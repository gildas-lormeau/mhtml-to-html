...
const TEXT_NODE_TAG_NAMES = ["STYLE", "SCRIPT", "XMP", "IFRAME", "NOEMBED", "NOFRAMES", "PLAINTEXT", "NOSCRIPT"];
...
function serializeTextNode(textNode) {
    ...
    if (parentNode.getAttribute !== undefined) {
        parentType = parentNode.getAttribute("type");
    }
    if (!parentTagName || TEXT_NODE_TAG_NAMES.includes(parentTagName)) {
        if ((parentTagName === "SCRIPT" && (parentType === undefined || parentType === "text/javascript")) || parentTagName === "STYLE") {
