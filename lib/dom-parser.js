...
const treeAdapter = {
    ...
    createElement(tagName, namespaceURI, attrs) {
        ...
        element.getAttribute = function (name) {
            const attribute = this.attrs.find(attr => attr.name === name);
        ...
        element.appendChild = function (child) {
            return treeAdapter.appendChild(element, child);
        };
        ...
        element.replaceWith = function (...nodes) {
            if (this.parentNode !== undefined) {
                const index = this.parentNode.childNodes.indexOf(this);
                if (index !== -1) {
        ...
        element.prepend = function (...nodes) {
            this.childNodes.unshift(...nodes);
            nodes.forEach(node => node.parentNode = this);
        };
        element.after = function (...nodes) {
            if (this.parentNode !== undefined) {
                const index = this.parentNode.childNodes.indexOf(this);
                if (index !== -1) {
