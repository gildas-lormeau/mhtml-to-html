...
function setAttribute(name, value) {
    const indexAttribute = findIndexAttribute.call(this, name);
    if (indexAttribute === -1) {
...
function getAttribute(name) {
    const attribute = findAttribute.call(this, name);
...
function findAttribute(name) {
    return this.attrs.find(attr => testAttributeName(attr, name));
}

function findIndexAttribute(name) {
    return this.attrs.findIndex(attr => testAttributeName(attr, name));
}
