...
deno compile --allow-read --allow-write --allow-net --ext=js --output=./dist/mhtml-to-html-aarch64-apple-darwin --target=aarch64-apple-darwin ./mhtml-to-html
deno compile --allow-read --allow-write --allow-net --ext=js --output=./dist/mhtml-to-html-x86_64-apple-darwin --target=x86_64-apple-darwin ./mhtml-to-html
